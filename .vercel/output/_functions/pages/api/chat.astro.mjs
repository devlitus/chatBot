...
import { c as createInvalidVariablesError, g as getEnv$1, s as setOnSetGetEnv } from '../../chunks/runtime_DlDR5xPS.mjs';
export { renderers } from '../../renderers.mjs';

const schema = {"GEMINI_API_KEY":{"access":"secret","context":"server","type":"string"}};
...
setOnSetGetEnv(() => {
	GEMINI_API_KEY = _internalGetSecret("GEMINI_API_KEY");

});
let GEMINI_API_KEY = _internalGetSecret("GEMINI_API_KEY");
